...
/**
 * Creates flame objects and provides utility methods.
 */
object DefaultFlame {
  /**
   * Creates a new flame.
   ...
   */
  def apply(f: Flame): Flame =
    apply(f.flameLength, f.angle, f.origin, f.depthIgnited, f.deltaTemperature)
    
  /**
   * Creates a new flame with the same attributes as an existing flame but at a
  ...
  /////////////////////////////////////////////////////////////////////////////
  //
  //          Private class representing a flame.
  //
  /////////////////////////////////////////////////////////////////////////////
